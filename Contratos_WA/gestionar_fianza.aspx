<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="gestionar_fianza.aspx.vb" Inherits="Contratos_WA.gestionar_fianza" %>
...
<div class="card mb-0">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Gestionar fianzas</h5>  
             <asp:GridView ID="gridListfianzas" RowStyle-Font-Size="Large" runat="server" CssClass="mt-1 table mb-0 align-middle" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:TemplateField HeaderText="id_fianza" Visible="False">
                              <ItemTemplate>
                                  <asp:LinkButton ID="Lnk_id_fianza" runat="server" Text='<%# Eval("id_fianza") %>'></asp:LinkButton>
                              </ItemTemplate>
                           </asp:TemplateField>
                            <asp:TemplateField HeaderText="N° de fianza">
                              <ItemTemplate>
                            ...
                            <asp:BoundField DataField="NoContrato" HeaderText="N° de contrato" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Font-Size="Small" HorizontalAlign="left" />
                            </asp:BoundField>
                           <asp:BoundField DataField="tipo_fianza" HeaderText="Tipo de fianza" >
                            ...
                            <asp:BoundField DataField="fecha_vencim_fianza" HeaderText="F. vencimiento" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Font-Size="Small" HorizontalAlign="left" />
                            </asp:BoundField>
