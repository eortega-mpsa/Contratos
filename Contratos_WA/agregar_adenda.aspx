<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="agregar_adenda.aspx.vb" Inherits="Contratos_WA.agregar_adenda" %>
...
<div>
 ...
 <div class="card mb-0">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Nueva Adenda | <asp:LinkButton ID="LinkButton1" runat="server">Gestionar Adendas</asp:LinkButton></h5>  
       <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="NoAdenda" class="form-label">No. de Adenda</label>
            <input type="text" class="form-control" id="NoAdenda" name="NoAdenda"  required="required" aria-describedby="emailHelp" oninvalid="this.setCustomValidity('No ha introducido el número de adenda')" oninput="setCustomValidity('')">
        </div>
        <div class="mb-3">
